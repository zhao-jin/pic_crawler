    #coding:utf-8 import re,os,shutil,sys import
         urllib2,socket,cookielib from threading import
         Thread,stack_size,Lock from Queue import Queue import time
         from gzip import GzipFile from StringIO import StringIO
